...
/*////////////////////////////////////////////////
// Code below commented out because the code has
// been implemented into 2 files instead for
...
int main()
{
	...
	GLFWwindow* myWindow = glfwCreateWindow(1000, 1000, "Board", NULL, NULL);
	if (myWindow == NULL)
	{
	...
	*/
	...
	Shader orangeShader("shader.vert", "shader.frag"); // you can name your shader files however you like
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(vertices), vertices, GL_STATIC_DRAW);
	/*///////////////////////////////////////////////////////////////////////////////////
	// CODE below commented out because it was implemented into shader.h
